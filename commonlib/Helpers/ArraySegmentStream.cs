...
namespace ChainsAPM.Helpers
{
    public class ArraySegmentStream
    {
        ...
        public string GetUnicode(int length) { int countercopy = internalCounter; internalCounter += length * 2; return System.Text.UnicodeEncoding.Unicode.GetString(segmentRef.Array, internalCounter, length); }
        public string GetASCII(int length) { int countercopy = internalCounter; internalCounter += length; return System.Text.UnicodeEncoding.Unicode.GetString(segmentRef.Array, internalCounter, length); }
