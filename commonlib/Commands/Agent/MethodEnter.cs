...
{
    public class MethodEnter : Interfaces.ICommand<byte>
    {
        ...
        public MethodEnter(System.Int64 timestamp, System.Int64 _threadid, System.Int64 _moduleid, System.Int64 _methoddef) : this()
        {
        ...
        public Interfaces.ICommand<byte> Decode(ArraySegment<byte> input)
        {
            ...
            if (input.Count != 0)
            {
                ...
                if (input.Count == size)
                {
                    ...
                    return new MethodEnter(timestamp, decodeThreadID, decodeModuleID, decodeMethodDef);
                    }
                    else
                    {
